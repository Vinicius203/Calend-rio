...
const eventClassInput = document.getElementById('eventClassInput');
...
function load() {
  ...
  document.getElementById('monthDisplay').innerText =
    `${capitalizeFirstLetter(dt.toLocaleDateString('pt-br', { month: 'long' }))} de ${year}`;
